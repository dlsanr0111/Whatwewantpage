    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-4">
        <div className="flex items-center justify-between">
          ...
          >
            <motion.div
              className="w-9 h-9 sm:w-8 sm:h-8 rounded-full bg-gradient-to-br from-[#88c8c3] to-[#a8b5ff] flex items-center justify-center shadow-lg"
              whileHover={{ rotate: 360 }}
              transition={{ duration: 0.6 }}
            >
              <span className="text-white text-base sm:text-base font-bold">W</span>
            </motion.div>
            <span className="tracking-wider text-base sm:text-base font-bold group-hover:text-[#88c8c3] transition-colors">
              WWW
            </span>
          </motion.button>
